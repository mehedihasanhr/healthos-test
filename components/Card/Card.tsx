    ...
    return (
        <Link href={href}>
            <div className="relative w-full rounded-lg overflow-hidden bg-white border border-dashed hover:border-blue-300">
                ...
                <div className="py-3 px-5 md:px-2 h-32 sm:h-[150px] md:h-52 xl:h-48  xxl:h-56 overflow-hidden">
                    <div className="relative h-32 sm:h-[150px] md:h-52 xl:h-48  xxl:h-56">
                        {image ? (
                            <Image
                                src={image}
                                alt={alt}
