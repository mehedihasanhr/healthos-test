                    ...
                    <div className="col-span-12 sm:col-span-7 lg:col-span-5 border-b lg:border-0 lg:border-r border-dashed border-gray-100">
                        ...
                        <div className="my-3 mb-5">
                            <p className="block text-xs text-gray-500 max-w-[650px] font-base">
                                ...
                                adipisicing elit. Dolorum quidem veritatis
                                dignissimos debitis eveniet possimus tenetur
                                delectus vel sapiente ullam iusto illum
                                consectetur voluptates necessitatibus molestiae,
                                reiciendis vitae corporis mollitia?
                            </p>
                        </div>
                                ...
                                <div className="px-3">
                                    ...
                                    <div className="text-gray-500 border border-dashed p-2 mt-2">
                                        <p className="text-xs ">
                                            ...
                                            minimum spend 7 items in certain
                                            area from Music Mart.
                                        </p>
                                        <div className="text-[10px] mt-2 text-gray-500 bg-gray-100 p-2">
                                            <p className="text-gray-700 font-medium">
                                                <i className="fi fi-rr-info" />
                                                <span className="ml-2">
                                                    Free shipping promotion is
                                                    valid for standard delivery
                                                </span>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="px-3">
                                    <div className="text-xs mt-2 text-gray-500 border border-dashed border-blue-100 bg-blue-50/10 p-2">
                                        <p className="flex items-center gap-2 text-blue-400 font-medium">
                                            ...
                                            <span className="ml-2">
                                                Cash on delivery is available in
                                                certain area from Music
                                            </span>
                                        </p>
                                    </div>
                                </div>
